...
export default function Articles() {
  ...
  let newsFilter = [
    ...
    },
    {
      ...
      api: `https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=${apiKey}`,
    },
    {
      id: 4,
      title: "Tesla News",
      api: `https://newsapi.org/v2/everything?q=tesla&from=2024-06-04&sortBy=publishedAt&apiKey=${apiKey}`,
    },
    {
      id: 5,
  ...
  return (
    <div className="container min-h-[calc(100vh-213px)] mt-[100px]">
      <div class="text-center mb-10 mt-10">
        <h1 class="capitalize text-main text-4xl font-semibold">Articles</h1>
        ...
        {newsFilter.map((news) => {
          return (
            <button
              key={news.id}
              className={`${
                news.id === activeId ? "bg-main" : "bg-gray-200"
              }  font-medium text-sm  text-white text-center py-1 md:py-1 px-1 rounded cursor-pointer`}
              onClick={(e) => {
